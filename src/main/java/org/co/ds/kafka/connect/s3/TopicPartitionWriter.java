...
import org.co.ds.kafka.connect.s3.util.FileRotationTracker;
import org.co.ds.kafka.connect.s3.util.RetryUtil;
import org.co.ds.kafka.connect.s3.util.TombstoneTimestampExtractor;
...
public class TopicPartitionWriter {
  ...
  public String fileKeyToCommit(String dirPrefix, long startOffset) {
  ...
  private void tagFile(
    ...
    try {
      storage.addTags(s3ObjectPath, tags);
        assert extraHashMapTag != null;
        log.info("Tagged S3 object {} with starting offset {}, ending offset {}, record count {}, extra tags {}",
          s3ObjectPath, startOffset, endOffset, recordCount, extraHashMapTag);
