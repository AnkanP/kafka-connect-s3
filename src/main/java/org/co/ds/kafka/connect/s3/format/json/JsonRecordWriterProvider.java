...
package org.co.ds.kafka.connect.s3.format.json;

import com.fasterxml.jackson.core.JsonGenerator;
import com.fasterxml.jackson.databind.ObjectMapper;
import org.co.ds.kafka.connect.s3.storage.IORecordWriter;
import org.co.ds.kafka.connect.s3.format.S3RetriableRecordWriter;
import org.apache.kafka.connect.data.Struct;
import org.apache.kafka.connect.json.JsonConverter;
import org.apache.kafka.connect.sink.SinkRecord;
import org.co.ds.kafka.connect.s3.S3SinkConnectorConfig;
import org.co.ds.kafka.connect.s3.format.RecordViewSetter;
import org.co.ds.kafka.connect.s3.format.RecordViews;
import org.co.ds.kafka.connect.s3.storage.S3OutputStream;
import org.co.ds.kafka.connect.s3.storage.S3Storage;
import org.co.ds.kafka.connect.s3.util.S3ErrorUtils;
import org.co.ds.kafka.connect.s3.util.Utils;
  ...
  public RecordWriter getRecordWriter(final S3SinkConnectorConfig conf, final String filename) {
    try {
      return new S3RetriableRecordWriter(
          new IORecordWriter() {
            final String adjustedFilename = Utils.getAdjustedFilename(recordView, filename,
                getExtension());
            ...
            public void write(SinkRecord record) throws IOException {
              log.trace("Sink record with view {}: {}", recordView,
                  Utils.sinkRecordToLoggableString(record));
              // headers need to be enveloped for json format
              boolean envelop = recordView instanceof RecordViews.HeaderRecordView;
