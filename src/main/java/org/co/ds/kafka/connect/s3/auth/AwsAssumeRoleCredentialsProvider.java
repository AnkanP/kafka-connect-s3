...
package org.co.ds.kafka.connect.s3.auth;
...
public class AwsAssumeRoleCredentialsProvider implements AWSCredentialsProvider, Configurable {
  ...
  public void configure(Map<String, ?> configs) {
    ...
    final String accessKeyId = (String) configs.get(S3SinkConnectorConfig.AWS_ACCESS_KEY_ID_CONFIG);
    final String secretKey = (String) configs.get(S3SinkConnectorConfig.AWS_SECRET_ACCESS_KEY_CONFIG);
